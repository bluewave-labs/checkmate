          ...
          <Stack gap={theme.spacing(10)} mt={theme.spacing(10)}>
            ...
            <Stack direction="row" gap={theme.spacing(8)}>
              <StatBox
                ...
                heading={"active for"}
                subHeading={splitDuration(
                  monitor?.stats?.timeSinceLastFalseCheck
                )}
              />
              <StatBox
                heading="last check"
            ...
            <Box>
              ...
              <Stack direction="row" flexWrap="wrap" gap={theme.spacing(8)}>
                    ...
                    <Box position="relative">
                      ...
                      <Typography component="span">
                        {hoveredUptimeData !== null
                          ...
                          : (monitor.stats?.upChecksAggregate?.totalChecks ??
                            0)}
                      </Typography>
                      {hoveredUptimeData !== null &&
                    ...
                    <Box>
                      ...
                      <Typography component="span">
                        {hoveredUptimeData !== null
                          ...
                          : Math.floor(
                              ((monitor?.stats?.upChecksAggregate
                                ?.totalChecks ?? 0) /
                  ...
                  <Box position="relative">
                    ...
                    <Typography component="span">
                      {hoveredIncidentsData !== null
                        ...
                        : (monitor.stats?.downChecksAggregate?.totalChecks ??
                          0)}
                    </Typography>
                    {hoveredIncidentsData !== null &&
                ...
                <ChartBox justifyContent="space-between">
                  ...
                  <ResponseGaugeChart
                    avgResponseTime={
                      monitor?.stats?.groupAggregate?.avgResponseTime ?? 0
                    }
                  />
                </ChartBox>
